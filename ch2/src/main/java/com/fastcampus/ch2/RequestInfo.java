...
public class RequestInfo {
    ...
    public void main(HttpServletRequest request) {
        ...
        System.out.println("request.getServerPort()="+request.getServerPort()); // 서버 포트 8000
        System.out.println("request.getRequestURL()="+request.getRequestURL()); // 요청 URL http://localhost:8000/ch2/requestInfo
        System.out.println("request.getRequestURI()="+request.getRequestURI()); // 요청 URI /ch2/requestInfo

        System.out.println("request.getContextPath()="+request.getContextPath()); // context path /ch2
        System.out.println("request.getServletPath()="+request.getServletPath()); // servlet path /requestInfo
...
//http:localhost:8000/ch2/requestInfo?year=2021&month=10&day=1